...
==================================================
 Ce fichier correspond uniquement à la vue.
 Il sert à afficher les données préparées par le contrôleur.
 La structure doit rester simple, lisible et bien organisée.

 Règles de cette vue :
 - affichage uniquement
 - pas de logique métier ici
 - pas de CSS ici
 - structure HTML/PHP claire
==================================================
*/
...
/*
|--------------------------------------------------------------------------
| Préparation sécurisée des variables d'affichage
|--------------------------------------------------------------------------
| La vue protège les données reçues pour garder un rendu propre
| et éviter les erreurs d'affichage si certaines valeurs sont absentes.
|--------------------------------------------------------------------------
*/
$dossier = $dossier ?? [];
$examens = $examens ?? [];
...
|--------------------------------------------------------------------------
| Cette partie reste dans la vue pour préparer uniquement
| un libellé d'affichage simple à présenter dans le bloc dossier.
|--------------------------------------------------------------------------
*/
...
<div class="dossier-grid">
    ...
    <div class="card">
        ...
        <table class="table">
            <tbody>
                <tr>
                    <th style="width:220px;">Date / heure arrivée</th>
                ...
                <!-- Affichage d'information médicale déjà préparée pour la vue -->
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <?php if (!empty($dossier['numeroLit'])): ?>
                            ...
                            on montre simplement l'action si les données reçues le permettent.
                            La décision métier reste gérée ailleurs.
                            ------------------------------------------------------------------
                            */
                ...
                <?php foreach ($equipementsReserves as $eq): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            /*
                            ------------------------------------------------------------------
                            Affichage d'état et actions d'interface :
                            - reserve => bouton Utiliser
                            - occupe  => bouton Libérer
                            Cette partie reste purement orientée affichage.
                            ------------------------------------------------------------------
                            */
...
<!--
------------------------------------------------------------------------------
Fenêtre modale d'interface :
ce bloc appartient à la vue car il concerne uniquement l'affichage
et la confirmation visuelle côté utilisateur.
------------------------------------------------------------------------------
-->
