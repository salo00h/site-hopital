...
/*
==================================================
 VIEW : Modifier dossier patient
==================================================
 Ce fichier correspond uniquement à l'affichage.
 Il présente le formulaire de modification du dossier
 sans contenir de logique métier.

 Principes de cette vue :
 - affichage uniquement
 - structure simple et lisible
 - pas de logique métier ici
 - pas de CSS ici
 - code clair pour faciliter la maintenance
==================================================
*/
...
|--------------------------------------------------------------------------
| Ces fonctions servent uniquement à sécuriser et formater
| les valeurs visibles dans le formulaire.
|--------------------------------------------------------------------------
*/
...
<div class="card">
    <form class="form" method="post" action="index.php?action=dossier_update">
        ...
        /*
        ----------------------------------------------------------------------
        Partie affichage : informations du patient
        Cette section reste volontairement simple pour garder
        une lecture claire du formulaire côté vue.
        ----------------------------------------------------------------------
        */
        ?>
        <h3>Patient</h3>
        ...
        /*
        ----------------------------------------------------------------------
        Partie affichage : informations du dossier
        Le but ici est uniquement de présenter les champs
        du dossier de manière propre et cohérente.
        ----------------------------------------------------------------------
        */
        ?>
        <h3>Dossier</h3>
